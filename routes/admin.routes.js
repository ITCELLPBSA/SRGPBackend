...
adminRouter.post("/bulkInsert",mgmtAuth, (req, res, next) => {
    adminService.bulkInsert(req.body,req.auth.userRole)
    .then(response => res.send(response))
    .catch(error => next(error));
});
adminRouter.post("/bulkDelete",mgmtAuth, (req, res, next) => {
    adminService.bulkDelete(req.body,req.auth.userRole)
    .then(response => res.send(response))
    .catch(error => next(error));
});
